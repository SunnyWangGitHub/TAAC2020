...
sys.path.append('../')
sys.path.append('../../')
from data_process import w2v_train,w2v_test,w2v_matrix,w2v_cal
...
def test_worker(i,my_opt):
        ...
        ad_id_embedding_word2vec_matrix,creative_id_embedding_word2vec_matrix,advertiser_id_embedding_word2vec_matrix,product_id_embedding_word2vec_matrix,industry_id_embedding_word2vec_matrix = w2v_matrix()
        model = my_opt(word_seq_len,ad_id_embedding_word2vec_matrix,creative_id_embedding_word2vec_matrix,advertiser_id_embedding_word2vec_matrix,product_id_embedding_word2vec_matrix,industry_id_embedding_word2vec_matrix,classification)    
        
        del ad_id_embedding_word2vec_matrix
        del creative_id_embedding_word2vec_matrix
        del advertiser_id_embedding_word2vec_matrix
        del product_id_embedding_word2vec_matrix
        del industry_id_embedding_word2vec_matrix
        gc.collect()
        ...
        cb = [  EarlyStopping(monitor='val_output_age_acc', patience=4, verbose=0),
                ReduceLROnPlateau(monitor='val_output_age_acc', factor=factor, patience=2, min_lr=0.0001, verbose=1),
                checkpoint]
...
#         test_tf_idf = test_tfidf.drop(['user_id'],axis=1)
        ...
        ad_id_test_,creative_id_test_,advertiser_id_test_,product_id_test_,industry_id_test_ = w2v_test()
  

        print('predicting....')
#         test_model_pred =  model.predict([ad_id_test_,creative_id_test_,advertiser_id_test_,product_id_test_,industry_id_test_,test_tf_idf,countvec_test])
        test_model_pred =  model.predict([ad_id_test_,creative_id_test_,advertiser_id_test_,product_id_test_,industry_id_test_,countvec_test])
...
#     del train_tfidf_csv
    ...
    # ad_id_train_,ad_id_test_,advertiser_id_train_,advertiser_id_test_,product_id_train_,product_id_test_,ad_id_embedding_word2vec_matrix,advertiser_id_embedding_word2vec_matrix,product_id_embedding_word2vec_matrix = w2v_pad_ad_adv_product_industry_train(train,test, word_seq_len)
    # ad_id_train_,ad_id_test_,advertiser_id_train_,advertiser_id_test_,product_id_train_,product_id_test_,ad_id_embedding_word2vec_matrix,advertiser_id_embedding_word2vec_matrix,product_id_embedding_word2vec_matrix = w2v_pad_ad_adv_product_industry_use(train,test, word_seq_len)
    
#     test_data = pd.read_csv('../data_process/test_all_data_6_17.csv')
#     test = pd.DataFrame(test_data)
#     w2v_cal(train,test, word_seq_len)
#     del test_data
#     del test
    

    ad_id_train_,creative_id_train_,advertiser_id_train_,product_id_train_,industry_id_train_ = w2v_train()

#     train_data = np.hstack((ad_id_train_,creative_id_train_,advertiser_id_train_,product_id_train_,industry_id_train_,train_tf_idf,countvec_train))

    train_data = np.hstack((ad_id_train_,creative_id_train_,advertiser_id_train_,product_id_train_,industry_id_train_,countvec_train))
    ...
    for i, (train_fold, val_fold) in enumerate(splits):
        ...
        # 200 200 128 100 50
#         X_train = np.split(X_train,[190,190*2,190*3,190*4,190*5,190*6],axis = 1)
#         X_valid = np.split(X_valid,[190,190*2,190*3,190*4,190*5,190*6],axis = 1)

        X_train = np.split(X_train,[190,190*2,190*3,190*4,190*5],axis = 1)
        X_valid = np.split(X_valid,[190,190*2,190*3,190*4,190*5],axis = 1)
        ...
        test_process.start()
        test_process.join()
        # training_worker(i,my_opt,ad_id_embedding_word2vec_matrix,advertiser_id_embedding_word2vec_matrix,product_id_embedding_word2vec_matrix,X_train,X_valid,y_train,y_valid,ad_id_test_,advertiser_id_test_,product_id_test_,test_tf_idf,countvec_test)
